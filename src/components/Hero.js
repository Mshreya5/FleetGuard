...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Blue tint */}
      <div style={{ position: 'absolute', inset: 0, background: 'rgba(30,58,95,0.38)' }} />
      {/* Glow top-left */}
      <div style={{
        position: 'absolute', top: '-160px', left: '-160px',
        width: '600px', height: '600px', borderRadius: '50%',
        background: 'rgba(29,78,216,0.18)', filter: 'blur(120px)',
        pointerEvents: 'none',
      }} />
      {/* Glow bottom-right */}
      <div style={{
        ...
        background: 'rgba(74,144,226,0.13)', filter: 'blur(100px)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        padding: `96px ${SPACING[6]} ${SPACING[20]}`,
        display: 'grid',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: SPACING[8] }}>
          ...
          {/* Description */}
          <p className="fg-fade-up-2" style={{
            color: COLORS.textSecondary,
            fontSize: FONT.size.base,
            lineHeight: 1.75, maxWidth: '440px',
          }}>
            Manage fleet vehicles, compliance documents, maintenance schedules,
            and driver assignments from one centralized platform.
          </p>
          ...
          {/* Stats */}
          <div className="fg-fade-up-3" style={{
        ...
        <div className="fg-fade-right" style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: SPACING[2] }}>
                <div style={{
                  ...
                  background: COLORS.primary, borderRadius: RADIUS.btn,
            ...
            <div style={{
              ...
              <a href="/login" style={{
                fontSize: FONT.size.xs, fontWeight: FONT.weight.semibold,
                color: COLORS.primaryLight, textDecoration: 'none',
              }}>View All →</a>
            </div>
          </div>
        </div>
