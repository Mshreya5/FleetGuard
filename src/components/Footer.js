  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'rgba(74,144,226,0.07)', filter: 'blur(80px)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: SPACING[5], gridColumn: 'span 2' }}>
          <a href="#home" style={{ display: 'inline-flex', alignItems: 'center', gap: SPACING[2], textDecoration: 'none' }} className="fg-logo">
            <div
              className="fg-logo-icon"
              style={{
                width: '36px', height: '36px',
                background: COLORS.primary, borderRadius: RADIUS.card,
          ...
          <p style={{
            ...
            The all-in-one fleet maintenance and compliance management platform
            for modern enterprises.
          </p>
          <div style={{
            width: '48px', height: '2px',
            borderRadius: '2px', background: 'rgba(74,144,226,0.5)',
          }} />
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: SPACING[4] }}>
          ...
          <ul style={{ display: 'flex', flexDirection: 'column', gap: SPACING[2], listStyle: 'none' }}>
            {quickLinks.map(({ label, href }) => (
              <li key={label}>
                <a
                  href={href}
                  className="fg-footer-link"
                  style={{
                    fontSize: FONT.size.sm, color: COLORS.textSecondary,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: SPACING[4] }}>
          ...
          <ul style={{ display: 'flex', flexDirection: 'column', gap: SPACING[3], listStyle: 'none' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          alignItems: 'center', justifyContent: 'space-between', gap: SPACING[2],
        }}>
          <p style={{ fontSize: FONT.size.xs, color: COLORS.textSecondary }}>
            © 2026 FleetGuard. All rights reserved.
          </p>
          <div style={{ display: 'flex', gap: SPACING[6] }}>
            {['Privacy Policy', 'Terms of Service'].map((item) => (
              <a
                ...
                href="/legal"
                className="fg-footer-link"
                style={{ fontSize: FONT.size.xs, color: COLORS.textSecondary, textDecoration: 'none' }}
              >
                {item}
              </a>
            ))}
