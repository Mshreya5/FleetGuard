...
export default function About() {
  return (
    <section
      id="about"
      style={{ position: 'relative', padding: `${SPACING[24]} 0`, overflow: 'hidden' }}
    >
      {/* Background image */}
      <div style={{
      ...
      <div style={{
        ...
        background: 'rgba(29,78,216,0.13)', filter: 'blur(120px)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        <div className="fg-fade-left" style={{ display: 'flex', flexDirection: 'column', gap: SPACING[6] }}>
          <div>
            ...
            <h2 style={{
              fontSize: FONT.size['3xl'], fontWeight: FONT.weight.bold,
              color: COLORS.textPrimary, lineHeight: 1.25,
            }}>
              Built for enterprise{' '}
              <span style={{ color: COLORS.primaryLight }}>fleet operations</span>
            </h2>
            <div style={{
              marginTop: SPACING[4], width: '56px', height: '3px',
              borderRadius: '2px', background: COLORS.primary,
            }} />
          </div>

          <p style={{
            color: COLORS.textSecondary, fontSize: FONT.size.base, lineHeight: 1.75,
          }}>
          ...
          <ul style={{ display: 'flex', flexDirection: 'column', gap: '4px', listStyle: 'none' }}>
            {points.map((point) => (
              ...
              >
                ...
                />
                <span style={{
                  fontSize: FONT.size.sm, color: COLORS.textSecondary, lineHeight: 1.6,
                }}>{point}</span>
              </li>
            ))}
          </ul>
