...
dotenv.config({
    path: path.join(
        __dirname,
        "../src/modules/FleetManager/backend/.env"
    )
});
...
async function seedDatabase(): Promise<void> {
    try {
        ...
        const vehiclesData = [
            {
                ...
                complianceSummary: {
                    ...
                    insuranceExpiry: new Date("2026-10-10"),
                    pollutionStatus: "Valid",
                    pollutionExpiry: new Date("2026-09-05"),
                    fitnessStatus: "Valid",
                    fitnessExpiry: new Date("2026-11-20"),
                    overallStatus: "Valid"
                }
            },

            {
                ...
                complianceSummary: {
                    ...
                    pollutionStatus: "Valid",
                    pollutionExpiry: new Date("2026-08-12"),
                    fitnessStatus: "Valid",
                    fitnessExpiry: new Date("2026-07-30"),
                    overallStatus: "Expired"
                }
            },
...

            {
                ...
                complianceSummary: {
                    ...
                    pollutionStatus: "Valid",
                    pollutionExpiry: new Date("2026-09-18"),
...

            {
                ...
                pollution: {
                    status: "Valid",
                    expiryDate: new Date("2026-12-09")
                },
                fitness: {
                    status: "Valid",
                ...
                complianceSummary: {
                    ...
                    pollutionStatus: "Valid",
                    pollutionExpiry: new Date("2026-12-09"),
                    fitnessStatus: "Valid",
                    fitnessExpiry: new Date("2027-01-10"),
                    overallStatus: "Expiring Soon"
                }
            }
        ];
        ...
        console.log(
            `[FleetGuard Seed] Created ${insertedVehicles.length} vehicles.`
        );
        ...
        const usersData = [
            ...
            {
                name: "Ravi Kumar",
                email: "ravi@fleetguard.com",
                password: hashedPassword,
                role: "Driver",
                branch: "Bangalore",
                phone: "9000000005",
                licenseNumber: "KA0120220001111",
                status: "Active",
                assignedVehicle: "KA01AB1234"
            },
            {
                name: "SpeedFix Center",
                email: "speedfix@fleetguard.com",
                password: hashedPassword,
                role: "Service Center",
                branch: "Bangalore",
                phone: "9000000017",
        ...
        console.log(
            `[FleetGuard Seed] Created ${insertedUsers.length} users.`
        );
        ...
        const auditLogsData = [
            {
                ...
                ts: new Date(),
                user: "Anita Rao",
                userEmail: "anita@fleetguard.com",
                role: "Fleet Manager",
            ...
            },
            {
                ...
                ts: new Date(),
                user: "Admin User",
                userEmail: "admin@fleetguard.com",
                role: "Admin",
                action: "User Login",
                ...
                os: "Ubuntu 22.04",
                prev: "Logged out",
                next: "Session started",
                reason: "Routine login"
            },
            {
                id: "EVT-003",
                ts: new Date(),
                user: "Ravi Kumar",
                userEmail: "ravi@fleetguard.com",
                role: "Driver",
                action: "Assignment Override Attempt",
            ...
            },
            {
                ...
                os: "Windows 11",
                prev: "Expired",
                next: "Valid till Oct 2026",
                reason: "Annual renewal"
            },
            {
                id: "EVT-005",
                ts: new Date(),
                user: "SpeedFix Center",
                userEmail: "speedfix@fleetguard.com",
                role: "Service Center",
        ...
        console.log(
            "[FleetGuard Seed] ✅ Database successfully seeded with rich initial data!"
        );
