...
const getServiceCosts = async (req: any, res: any) => {
  try {
    const history = await ServiceHistory.find({}).sort({ createdAt: -1 }).lean();
    const costs = history.map((h: any) => ({
      _id: h._id,
...
const createServiceCost = async (req: any, res: any) => {
  try {
...
const getServiceHistory = async (req: any, res: any) => {
  try {
...
const createServiceHistory = async (req: any, res: any) => {
  try {
...
const getServiceSchedules = async (req: any, res: any) => {
  try {
    const queue = await ServiceQueue.find({}).sort({ createdAt: -1 }).lean();
    const schedules = queue.map((q: any) => ({
      _id: q._id,
...
const createServiceSchedule = async (req: any, res: any) => {
  try {
...
const getMaintenanceRisk = async (req: any, res: any) => {
  try {
...
const completeServiceExtension = async (req: any, res: any) => {
  try {
