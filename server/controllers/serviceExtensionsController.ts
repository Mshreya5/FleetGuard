    ...
    try {
        ...
        const history =
            new ServiceHistory({
                ...
                description:
                    description ||
                    `Labour: $${labourCost}, Parts: $${sparePartsCost}`
            });
        ...
        await logAudit({
            ...
            action:
                "Service Cost Recorded",

            module:
                "Maintenance",

            next:
                `Cost $${total} recorded for ${vehicle}`
        });
...
const createServiceHistory = async (
    ...
    try {
        ...
        await logAudit({
            ...
            action:
                "Historical Service Added",

            module:
                "Maintenance",

            next:
                `History record added for ${vehicle}`
        });
    ...
    try {
        ...
        const queueItem =
            new ServiceQueue({
                ...
                issue:
                    notes ||
                    `Scheduled inspection after ${serviceInterval} days`,
...
const getMaintenanceRisk = async (
    req:any,
    res:any
) => {
    ...
    try {
        ...
        let explanation:string =
            "Vehicle mileage is within safe operational limits.";

        let recommendation:string =
            "Standard routine checks recommended every 10,000 km.";
        ...
        if (numMileage > 80000) {
            ...
            explanation =
                "High mileage vehicle requiring immediate engine, brake, and suspension inspection.";

            recommendation =
                "Schedule comprehensive overhaul service immediately.";
            ...
            explanation =
                "Moderate wear and tear detected based on vehicle mileage.";

            recommendation =
                "Schedule routine oil change, tyre rotation, and brake check.";
        }
...
const completeServiceExtension = async (
    req:any,
    res:any
) => {
    ...
    try {
        ...
        const history =
            new ServiceHistory({
                ...
                description:
                    `Service completed. Next due: ${nextServiceDue || "10,000 km"}`
            });
        ...
        if (vehicleDoc) {
            ...
            vehicleDoc.maintenanceStatus =
                "Operational";

            vehicleDoc.status =
                vehicleDoc.driverAssigned !== "Unassigned"
                    ? "Assigned"
                    : "Available";

            vehicleDoc.lastServiceDate =
                new Date();
        ...
        await logAudit({
            ...
            next:
                `Service completed for ${reg}. Cost: $${totalCost}`
        });
        ...
        res.status(200).json({
            ...
            message:
                `Service marked as completed for ${reg}.`
        });
