...
const registerUser = async (
    ...
    try {
        ...
        // Check for prohibited extra fields
        ...
        if (extraFields.length > 0) {
            ...
            return res.status(400).json({
                ...
                message:
                    `Registration only accepts Name, Email, Password, Confirm Password, and Role. Please do not submit extraneous fields (${extraFields.join(", ")}).`
            });
        }
        ...
        if (!NAME_REGEX.test(cleanName)) {
            ...
            return res.status(400).json({
                ...
                message:
                    "Name must contain alphabets and spaces only (2-50 characters)"
            });
        }
    ...
    try {
        ...
        if (
            ...
            await logAudit({
                ...
                reason:
                    `Role mismatch. Account role is '${user.role}' but tried logging in as '${role}'`
            });
            ...
            return res.status(401).json({
                ...
                message:
                    `Access denied. Selected role '${role}' does not match registered account role '${user.role}'.`
            });
        }
        ...
        if (
            ...
            return res.status(403).json({
                ...
                message:
                    "Account is blocked. Please contact system administrator."
            });
        }
        ...
        if (
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    message:
                        "Driver license format is invalid"
                });
            }
...
const deleteUser = async (
    ...
    try {
        ...
        res.status(200).json({
            ...
            message:
                "User deleted and active driver assignments unassigned"
        });
    ...
    try {
        ...
        if (
            ...
            return res.status(400).json({
                ...
                message:
                    "New password must be at least 8 characters long and contain uppercase, lowercase, a digit, and a special character."
            });
        }
...
const getFleetManagerCount = async (
    req:any,
    res:any
) => {
