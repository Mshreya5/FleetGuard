...
const recalculateComplianceStatus = async (vehicleId: any) => {
  try {
...
// GET ALL VEHICLES
const getVehicles = async (req: any, res: any) => {
  try {
...
const getVehicleCount = async (req: any, res: any) => {
  try {
...
const getMaintenanceCount = async (req: any, res: any) => {
  try {
